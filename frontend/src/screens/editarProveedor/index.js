...
function EditarProveedor() {
  ...
  const [proveedor, setProveedor] = useState({ name: "", direccion: "", email: "", telefono: "" });
    ...
    <div className="home-container"
      ...
      <div className="content">
        ...
        <form className="form-container" onSubmit={handleSubmit}>
          ...
          <input type="email" name="email" value={proveedor.email} onChange={handleChange} placeholder="Correo Electrónico" required />
          <input type="tel" name="telefono" value={proveedor.telefono} onChange={handleChange} placeholder="Teléfono" required />
