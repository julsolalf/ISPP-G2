...
VALUES (1, 'Restaurante La Trattoria', 12345, 'Calle Falsa 123', '28001', 'Madrid', 'España', (SELECT id FROM dueno WHERE first_name = 'Carlos'));
INSERT INTO negocio (id, name, token_negocio, direccion, codigo_postal, ciudad, pais, dueno_id) 
VALUES (2, 'Restaurante Burguer', 09876, 'Calle Falsa 123', '28001', 'Madrid', 'España', (SELECT id FROM dueno WHERE first_name = 'Carlos'));
