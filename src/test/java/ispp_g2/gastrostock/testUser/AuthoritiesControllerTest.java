...
class AuthoritiesControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(authoritiesController).build();
    ...
    void testFindAll_WithContent() throws Exception {
        ...
        verify(authoritiesService, times(2)).findAll();
    }
    ...
    void testSaveAuthorities_Success() throws Exception {
        ...
        newAuth.setAuthority("ROLE_NEW");
        
        Authorities savedAuth = new Authorities();
        savedAuth.setId(3);
        savedAuth.setAuthority("ROLE_NEW");
